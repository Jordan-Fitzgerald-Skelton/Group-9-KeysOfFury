...
#define instance_of
/// @description  instance_of(val:T, val:T)->bool
/// @param val:T
/// @param  val:T
/**
...
#define it
/// @description  it(val:T, val:T, val:T)-> bool
/// @param val:T
/// @param  val:T
/// @param  val:T
/**
...
#define obj_exists
/// @description  obj_exists(val:T)->int
/// @param val:T
obj = argument[0]
...
/// @description  simulate_mouse_click(mb_left, x, y)
/// @param mb_left
/// @param  x
/// @param  y
...
#define should_be
/// @description  should_be(arg, arg, arg)
/// @param arg
/// @param  arg
/// @param  arg
